...
export default function CardTableNecessitados({ color }) {
  ...
  const handleStatusChange =async (row) => {
    const res=await axios.put("http://localhost:3000/alteraStatusNecessitados",row)
    setTeste(1)
    setTeste(0)
    return res
  };
...
CardTableNecessitados.defaultProps = {
  color: "light",
};

CardTableNecessitados.propTypes = {
