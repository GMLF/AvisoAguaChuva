...
export class CriaçãodaTabelaDoaçãoENecessitadosCriaçãoTabelaRegistro1702589631343 implements MigrationInterface {
    name = 'CriaçãodaTabelaDoaçãoENecessitadosCriaçãoTabelaRegistro1702589631343'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "chuva" ("cidade" character varying NOT NULL, "precip" character varying NOT NULL, "alerta" character varying NOT NULL, CONSTRAINT "PK_9cad6d34bb4c5dc1e95aeecb819" PRIMARY KEY ("cidade"))`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP TABLE "chuva"`);
