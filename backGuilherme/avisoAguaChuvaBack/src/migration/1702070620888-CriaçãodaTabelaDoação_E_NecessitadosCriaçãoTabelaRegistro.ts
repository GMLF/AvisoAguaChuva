...
export class CriaçãodaTabelaDoaçãoENecessitadosCriaçãoTabelaRegistro1702070620888 implements MigrationInterface {
    name = 'CriaçãodaTabelaDoaçãoENecessitadosCriaçãoTabelaRegistro1702070620888'
